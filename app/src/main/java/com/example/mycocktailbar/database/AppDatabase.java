...
@Database(entities = {Ingredient.class, Cocktail.class, CocktailIngredientCrossRef.class}, version = 23, exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
                            ...
                            .addCallback(new RoomDatabase.Callback() {
                                ...
                                public void onCreate(@NonNull SupportSQLiteDatabase db) {
                                    ...
                                    databaseWriteExecutor.execute(() -> {
                                        ...
                                        // Здесь должны быть вызовы insert для начальных данных
                                        fillWithInitialData(database);
                                    });
                                }
                            })
                            .build();
    ...
    private static void fillWithInitialData(AppDatabase database) {
